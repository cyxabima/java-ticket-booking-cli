...
public class TrainService {
    ...
    private static final String filePath = "app/src/main/java/ticket/booking/localDb/train.json";

    public TrainService() throws IOException {
        File trains = new File(filePath);
    ...
    private void saveTrainListToFile() {
        try {
            objectMapper.writeValue(new File(filePath), trainList);
        } catch (IOException e) {
